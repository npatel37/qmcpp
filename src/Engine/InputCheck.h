...
public:
	...
	void checkSimpleLabel(PsimagLite::String lastLabel, SizeType line) const
	{
	...
	void checkForThreads(size_t nthreads) const
	{
		...
		message1 += " FATAL: You are requesting nthreads>0 but you did not compile ";
		message1 += "with USE_PTHREADS enabled\n";
